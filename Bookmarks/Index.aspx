...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div>
        ...
        <asp:ListView ID="ListView3" runat="server" DataSourceID="PopularTags">
            <ItemTemplate>
                <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl='<%# Eval("name", "~/Bookmarks/Index.aspx?q={0}") %>'>

                <p><%# Eval("name") %>   Used: <%# Eval("popularity") %></p>
                </asp:HyperLink>
            </ItemTemplate>
        </asp:ListView>
    </div>
                        ...
                        <ItemTemplate>
                            ...
                            <div class="panel panel-default" runat="server">
                                ...
                                <div>
                                    ...
                                    <asp:HyperLink ID="Update" runat="server" NavigateUrl='<%# Eval("Id","~/Bookmarks/Edit.aspx?id={0}")%>'>Update Bookmark</asp:HyperLink>
                                </div>
